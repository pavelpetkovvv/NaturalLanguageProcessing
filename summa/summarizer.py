...
def summarize(text, clean_sentences=True, ratio=0.2, words=None, language="english", split=False, scores=False, additional_stopwords=None):
    if not isinstance(text, str):
        raise ValueError("Text parameter must be a Unicode object (str)!")

    print(clean_sentences)
    # Gets a list of processed sentences.
    sentences = _clean_text_by_sentences(text, language, additional_stopwords, clean_sentences)
